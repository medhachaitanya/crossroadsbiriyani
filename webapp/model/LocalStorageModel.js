sap.ui.define([
	...
	return JSONModel.extend("com.crossroadsbiriyani.customer.cart.model.CartModel", {
		 ...
		 * @return {com.crossroadsbiriyani.customer.cart.model.LocalStorageModel} the local storage model instance
		 */

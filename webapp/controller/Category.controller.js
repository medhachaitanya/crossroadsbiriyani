sap.ui.define([
	...
	return BaseController.extend("com.crossroadsbiriyani.customer.cart.controller.Category", {
		formatter : formatter,
		...
		onFilter: function () {
			...
			if (!this._pCategoryFilterDialog) {
				this._pCategoryFilterDialog = Fragment.load({
					...
					name: "com.crossroadsbiriyani.customer.cart.view.CategoryFilterDialog",
					controller: this

sap.ui.define([
	...
	return BaseController.extend("com.crossroadsbiriyani.customer.cart.controller.Welcome", {
		...
		onInit: function () {
			var oViewModel = new JSONModel({
				welcomeCarouselShipping: 'com/crossroadsbiriyani/customer/cart/img/ShopCarouselShipping.jpg',
				welcomeCarouselInviteFriend: 'com/crossroadsbiriyani/customer/cart/img/ShopCarouselInviteFriend.jpg',
				welcomeCarouselTablet: 'com/crossroadsbiriyani/customer/cart/img/ShopCarouselTablet.jpg',
				welcomeCarouselCreditCard: 'com/crossroadsbiriyani/customer/cart/img/ShopCarouselCreditCard.jpg',
				Promoted: [],
				Viewed: [],
				Favorite: [],
				Currency: "USD"

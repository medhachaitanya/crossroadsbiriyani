sap.ui.define([
	"sap/ui/test/Opa5",
	"sap/ui/util/Storage",
	"com/crossroadsbiriyani/customer/cart/localService/mockserver",
	...
	return Opa5.extend("com.crossroadsbiriyani.customer.cart.test.integration.arrangements.component.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.crossroadsbiriyani.customer.cart",
					manifest: true
				},
				hash: oOptions.hash,
